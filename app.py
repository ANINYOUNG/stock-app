...
with st.sidebar.expander("⚙️ 세부 재무/가격 필터 설정 (클릭하여 열기)"):
    ...
    st.session_state.use_vol_surge = st.checkbox("🔥 오늘 거래량 2배(200%) 폭발 종목만", value=st.session_state.use_vol_surge, help="평소(20일 평균) 대비 오늘 거래량이 엄청나게 터진 종목입니다. 시장의 돈이 몰리고 있다는 신호입니다.")
